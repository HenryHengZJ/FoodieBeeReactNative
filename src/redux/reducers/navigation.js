...
const getRefreshToken = createReducer({}, {
  [types.SET_RefreshToken](state, action) {
    return action;
  },
});
...
const getCustomerHasOrderedToday = createReducer({}, {
  [types.SET_CustomerHasOrderedToday](state, action) {
    return action;
  },
});
