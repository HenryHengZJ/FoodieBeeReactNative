...
const glutenfreeIcon = require('../img/glutenfree1.png');
const hotIcon = require('../img/fire.png');
const spicyIcon = require('../img/pepper.png');
const vegeIcon = require('../img/lettuce.png');
const healthyIcon = require('../img/fruit.png');
const halalicon = require('../img/halalsign.png');
        ...
        return (
            ...
            <ScrollView         
                ...
                <View style={{marginBottom: 150}}>
                    ...
                    {selectedLunchMenu.markitem.length > 0 ?

                     <View style={{marginLeft: 20, marginRight: 20, marginTop:20, flexDirection: 'row'}}>
                        {   selectedLunchMenu.markitem.map((data, index) => {
                                return(
                                    <View style={{flexDirection: 'row', marginRight: 20}}>
                                        <Image
                                            ...
                                            source={
                                                ...
                                                data === 'Halal' ? halalicon :
                                                data === 'Gluten Free' ? glutenfreeIcon :
                                                data === 'Vegetarian' ? vegeIcon :
                                                data === 'Healthy' ? healthyIcon : null
                                            } />
