...
class Prime extends Component {
    ...
    render() {
        ...
        <WebView
            source={{uri: `https://foodiebee.herokuapp.com/mobileaddpayment?customerEmail=${this.state.customerEmail}&customerPaymentAccountID=${this.state.customerPaymentAccountID}`}}
