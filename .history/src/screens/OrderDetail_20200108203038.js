...
class OrderDetail extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            secondline_notification: "You can now pickup meal at the updated time",
    ...
    render() {
        ...
        const { error, internetStatus, selectedLunchOrder, showNotification, notification_type, firstline_notification, secondline_notification} = this.state
