        ...
        const notificationMarginTop = showNotification ? 10 : 0;
            ...
            return (
                ...
                <ReviewModal
                    ...
                    profilesrc={this.state.selectedReview.length === 0 ? this.state.selectedLunchOrder.profilesrc : this.state.selectedReview.catererDetails[0].profilesrc}
                    catererName={this.state.selectedReview.length === 0 ? this.state.selectedLunchOrder.catererName : this.state.selectedReview.catererDetails[0].catererName}
                    starCount={this.state.selectedReview.length === 0 ? 0 : this.state.selectedReview.customerRating}
                    reviewComment={this.state.selectedReview.length === 0 ? "" : this.state.selectedReview.customerComment}>
                </ReviewModal> 
