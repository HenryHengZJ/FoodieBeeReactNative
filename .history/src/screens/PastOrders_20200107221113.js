        ...
        <Touchable 
            ...
            <View style={{  marginLeft: 10, marginTop: 10, marginBottom: 20, marginRight: 10, flexDirection: 'row' }}>
                ...
                <View style={{ marginLeft: 10, flexDirection: 'column', flex:1, marginRight: 10,}}>
                    ...
                    {   item.orderStatus === "pickedup" ? "€" + Number(item.totalOrderPrice).toFixed(2) + " charged" :
                        item.orderStatus === "cancelled" ? "€0 charged" :
                        item.orderStatus === "accepted" ? "€" + Number(item.totalOrderPrice).toFixed(2) + " charged" :
                        item.orderStatus === "rejected" ? "€0 charged" :
                        item.orderStatus === "pending" ? "€" + Number(item.totalOrderPrice).toFixed(2) + " charge pending" : ""}
                    </Text>
