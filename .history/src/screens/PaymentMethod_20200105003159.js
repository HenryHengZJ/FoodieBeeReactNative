...
class PaymentMethod extends Component {
    ...
    static navigationOptions = ({ navigation }) => ({
        ...
        handleButtonPress={() => navigation.state.params.handleAddPressed() } 
            location="right" color={colors.priceblue} text="ADD" />,
    });
    ...
    componentDidMount() {
        ...
        this.props.navigation.setParams({ handleAddPressed: this.handleAddNewCard });
    ...
    _renderItem = ({item, index}) => (
        ...
        <View style={{ margin: 10, borderWidth: 1, borderColor: '#ECECEC', padding:15, elevation:1, borderRadius: 10, backgroundColor: 'white' }}>
            ...
            <View  style={{ flexDirection: 'row', marginTop: 15, marginBottom: 10 }}>
                ...
                >
                    ...
                    <Text style={{ alignSelf: 'center', color: this.state.customerpaymentaccountdetails.invoice_settings.default_payment_method === item.id ? 'white' : colors.green01, fontWeight: '500', fontSize: 17}}>
        ...
        return (
            <View style={{ margin: 15, borderWidth: 1, borderColor: '#ECECEC', padding:15, elevation:1, borderRadius: 10, backgroundColor: 'white' }}>
                ...
                <ContentLoader
                    ...
                    listSize={5}
                    pRows={5}
                    pHeight={[30, 20, 10, 10, 40]}
                    pWidth={["20%", "50%", "70%", "60%", "100%"]}
                />
    ...
    render() {
        return (
        <View style={{ backgroundColor:'#F5F5F5', flex: 1, paddingTop: 10, }}>
            {this.state.loading ? this.renderLoadingView() : this.state.empty ? this.renderEmptyView() : this.renderLoadingView()}
        </View>
        )
    }
}
