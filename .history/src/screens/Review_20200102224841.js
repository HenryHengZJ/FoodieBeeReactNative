...
class Review extends Component {
    ...
    _renderItem = ({item, index}) => (
        ...
        <Touchable 
            style={{ margin: 15, borderWidth: 1, borderColor: '#ECECEC', padding:15, elevation:1, borderRadius: 10, backgroundColor: 'white' }}
            delayPressIn = {5000}
    ...
    renderFlatListView() {
        return (
            <List containerStyle={{ backgroundColor:'#F5F5F5', marginTop:0, paddingTop:0, paddingHorizontal: 5, borderBottomWidth: 0, borderTopWidth: 0, }}>
            <FlatList
