    ...
    return (
      <View style={{  marginVertical:20 ,marginHorizontal: 25, borderWidth: 1, borderRadius: 5, borderColor: '#d6d7da',  padding: 10}}>
        ...
        <TextInput 
            ...
            onChangeText={(value) => this.setState({userPhoneNumber: value})}
            value={phonenumber}
            style={{ padding: 0, color: colors.greyBlack,  marginHorizontal: 10, fontSize: 15}}>
         </TextInput>
      ...
      <TouchableOpacity style={{  marginVertical:20 ,marginHorizontal: 25,}}>
        ...
        >
            ...
            <View style={{ flex:1, borderWidth: 1, padding:10, borderRadius: 5, borderColor: '#d6d7da', flexDirection: 'row'}}>
                <Text style={{ alignSelf: 'center', fontWeight: '500', color: this.state.userCounty === "" ? 'gray' : 'black', fontSize: 17, }}>
                    {this.state.userCounty === "" ? "Select County" : this.state.userCounty} 
                </Text>
            </View>
      ...
      <KeyboardAvoidingView style={{ backgroundColor:'white', flex:1}}>
        ...
        <ScrollView 
          ...
          style={{backgroundColor:'transparent', flex:1}}>
            ...
            {this.renderFirstName(userFirstName)}

            <Text style={{color: colors.greyBlack, fontWeight: '500', paddingLeft:25, paddingRight:25, fontSize: 15}}>
              Last Name
            </Text>

            {this.renderLastName(userLastName)}

            <Text style={{color: colors.greyBlack, fontWeight: '500', paddingLeft:25, paddingRight:25, fontSize: 15}}>
              Phone Number
            </Text>

            {this.renderPhoneNumber(userPhoneNumber)}
            ...
            {this.renderHomeAddress(userAddress)}
            
            <Text style={{color: colors.greyBlack, fontWeight: '500', paddingLeft:25, paddingRight:25, fontSize: 15}}>
              County
            </Text>

            {this.renderCounty(userCounty? userCounty : '')}
