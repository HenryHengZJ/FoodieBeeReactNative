                ...
                <View 
                    ...
                    <TouchableOpacity
                        style={{ 
                            ...
                            onPress={this.showAlert.bind(this, "Select Pickup Time", "Please select a pickup time before ordering.")}
                          //  onPress={this.state.customerEmail === "" ? this.goToLogin.bind(this) : this.state.customerHasOrderedToday ? this.showAlert.bind(this, "Quota Used", "You have reached quota of 1 order per day.") : this.state.selectedPickUpTime === "" ? this.showAlert.bind(this, "Select Pickup Time", "Please select a pickup time before ordering.") : this.state.customerPaymentAccountID === "" ? this.addNewCard.bind(this) : this.getCustomerCard.bind(this)}
                        >
