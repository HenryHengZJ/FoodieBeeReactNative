...
class Register extends Component {
  ...
  handleLastNameChange(lastname) {
    this.setState({ customerLastName: lastname, validLastName: lastname === "" ? false : true });
  }
  ...
  onCreateAccount = () => {
    ...
    const { customerFirstName, customerLastName, customerEmail, customerPhoneNumber, password, companyID } = this.state;
  ...
  loginRegisteredUser = () => {
    ...
    const { customerEmail, password } = this.state;
