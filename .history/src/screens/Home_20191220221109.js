...
class HomePage extends Component {
    ...
    onAccountPressed = (navigation) => {
        if (typeof this.props.getUserid.userid === 'undefined') {
    ...
    renderLoadingView() {
        return (
            <View style={{ flex: 1, margin: 10, height: '100%' }}>
                <ContentLoader
                    active 
                    pRows={5}
                    pHeight={[180, 30, 20, 20]}
        ...
        <View style={{ flex: 1 }}>
            <StatusBar translucent backgroundColor='transparent' barStyle='dark-content' />
                <View style={{ backgroundColor: 'white', paddingTop: 20, flex: 1 }}>
                    ...
                    {this.state.loading ? this.renderLoadingView() : this.state.empty ? this.renderLoadingView() : this.renderLoadingView()}
