                ...
                <View 
                    ...
                    <TouchableOpacity
                        style={{ 
                            ...
                            onPress={() => this.state.customerEmail === "" ? this.goToLogin() : this.state.customerHasOrderedToday ? this.toggleLimitModal() : this.state.customerPaymentAccountID === "" ? this.togglePaymentCardModal() : this.getCustomerCard()}
                        >
        ...
        const { error, internetStatus, selectedLunchMenu} = this.state
            ...
            return (
                ...
                <OrderModal  
                    ...
                    handleOnPress = {this.state.orderStatus === "Success" ? this.goToMyOrders.bind(this) : this.dismissOrderModal.bind(this)}
                    txtmsg = {this.state.orderStatus === "Success" ? "" : ""}
                    buttonText = {this.state.orderStatus === "Success" ? "View Orders" : "OK"}
                    lottiejsonfile = {this.state.orderStatus === "Success" ? "success.json" : "failed.json"}
                >
                </OrderModal>
