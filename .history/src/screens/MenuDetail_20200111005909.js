    ...
    renderIcon(markitem) {
        ...
        for (let i = 0; i < markitem.length; i++) {
          iconarray.push(
                ...
                <Text style={{ fontSize: 15, alignSelf:'center', alignItems:'center', justifyContent:'center', fontWeight: '500', color: colors.greyBlack  }}>
                    {markitem[i]}
                </Text>
        ...
        return (
            ...
            <ScrollView         
                ...
                <View style={{marginBottom: 150}}>
                        ...
                        {   selectedLunchMenu.markitem.map((data, index) => {
                                return(
                                    <View style={{flexDirection: 'row', marginRight: 20}}>
                                        ...
                                        <Text style={{ marginLeft: 5, fontSize: 15, alignSelf:'center', alignItems:'center', justifyContent:'center', fontWeight: '500', color: colors.greyBlack  }}>
                                            {data}
                                        </Text>
                                    </View>
                                )
                    ...
                    {this.renderIcon(selectedLunchMenu.markitem)}
