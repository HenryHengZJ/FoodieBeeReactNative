    ...
    addNewCompany = () => {
        ...
        .then((response) => {
            if (response.status === 200) {
                ...
                Keyboard.dismiss()
                this.props.navigation.state.params.onAddCompanyClose(companyName)
            ...
            <View style={{ flex: 1, paddingTop: 120 }}>
                ...
                <Touchable
                    style={{ 
                        ...
                        justifyContent:'center',
                        elevation:2,
                        opacity: (this.state.addingCompany || this.state.companyName === "" || this.state.isSearchAddressMissing) ? 0.5 : 1.0,
                        backgroundColor: colors.priceblue}}
                    disabled={this.state.addingCompany || this.state.companyName === "" || this.state.isSearchAddressMissing }
                    ...
                    <View style={{ alignItems:'center', justifyContent:'center'}}>
                        ...
                        <Text style={{ paddingTop: 10, paddingBottom: 10, paddingLeft: 15, paddingRight: 15, color: 'white', fontWeight: '500', fontSize: 15}}>
                            {this.state.addingCompany ? "Adding..." : "Add Company"}
                        </Text>
