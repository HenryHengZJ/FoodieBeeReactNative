...
class Register extends Component {
  ...
  handlePhoneNumberChange(phonenumber) {
    if (isNaN(phonenumber)) {
    ...
    else if (phonenumber.includes("+") || phonenumber.includes("-") || phonenumber.includes(".")) {
      //Letters
    }
    else {
      //Valid Number
      this.setState({
        ...
        validPhoneNumber: phonenumber === "" ? false : true,
      });
    }
  }
  ...
  handleRepeatPasswordChange(repeatpassword) {
    const { validRepeatPassword } = this.state;
  ...
  toggleNextButtonState() {
    const { validFirstName, validLastName, validEmail, validPhoneNumber, validPassword, validRepeatPassword, } = this.state;
    if ( validFirstName && validLastName && validEmail && validPhoneNumber && validPassword && validRepeatPassword) {
      return false;
    }
    return true;
  }
