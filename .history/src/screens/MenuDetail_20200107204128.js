...
class MenuDetail extends Component {
    ...
    componentDidMount() {
        ...
        const customerHasOrderedToday = navigation.getParam('customerHasOrderedToday');
    ...
    payByDefaultCard = (customerPaymentCardID, customerPaymentCardBrand) => {
        ...
        .then((response) => {
            if (response.status === 200) {
                alert('response.data.id 2 = ', response.data.id, ' customerPaymentCardBrand = ', customerPaymentCardBrand)
