        ...
        return (
            ...
            <ScrollView         
                ...
                <View 
                    ...
                    <TouchableOpacity
                        disabled={this.state.isMenuExpired ? true : this.state.selectedPickUpTime === "" ? true : false}
                        style={{ 
                            opacity: this.state.isMenuExpired ? 0.5 : this.state.selectedPickUpTime === "" ? 0.5 : 1,
                            borderRadius:5, 
                            marginLeft: 20, 
                            flex:1,
                            paddingTop:10,
