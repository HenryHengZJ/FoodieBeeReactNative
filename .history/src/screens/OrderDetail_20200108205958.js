        ...
        .then((response) => {
            if (response.status === 201) {
                this.setState({
                    ...
                    secondline_notification: "Pickup meal at the updated time",
                    notification_type: "Success",
                    successText: "Pickup Time for Order #" + selectedLunchOrder.orderNumber + " has been successfully changed."
                }, () => {
                    this.getLunchOrder();
                })
            } 
          ...
          .then((response) => {
            if (response.status === 201) {
              this.setState({
                orderLunchModal: false,
                successModal: true,
                successText: "Order #" + selectedLunchOrder.orderNumber + " has been successfully cancelled. Nothings was charged from your account."
              }, () => {
                this.getLunchOrder();
              })
            } 
          ...
          .then((response) => {
            if (response.status === 201) {
              this.setState({
                orderLunchModal: false,
                successModal: true,
                successText: "You have picked up Order #" + selectedLunchOrder.orderNumber + " - " +  selectedLunchOrder.orderItem[0].title + ". You can leave your review later. Now, enjoy and eat!"
              }, () => {
                this.getLunchOrder();
              })
            } 
        ...
        return (
            ...
            <ScrollView         
                ...
                <View style={{marginBottom: 150}}>
                    ...
                    <View style={{ marginTop:10, marginLeft:20, marginRight:20, flexDirection: 'column'}}>
