...
class PastOrders extends Component {
    ...
    fetchData = () => {
        ...
        var headers = {
            ...
            'Authorization': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjdXN0b21lcklEIjoiNWNjMDg4MzRlYjhhMmExYTZjMjZiNTAxIiwiY3VzdG9tZXJOYW1lIjoiSGVucnkiLCJjdXN0b21lckVtYWlsIjoiaHpqOTRAaG90bWFpbC5jb20iLCJleHBpcmVzIjoiMjAxOS0xMi0yMVQyMDoxOTozMi42NjRaIiwiaWF0IjoxNTc2ODczMTcyLCJleHAiOjE1NzY5NTk1NzJ9.Sv8bsfj9bsBEB98bxMP4bl1iS4cGhE0BAs5tQFibCt4',
        }
        ...
        .then((response) => {
            alert("fetch error = " + JSON.stringify(response.headers));
