        ...
        const notificationMarginTop = showNotification ? 10 : 0;
            ...
            return (
                ...
                <ReviewModal
                    ...
                    profilesrc={typeof this.state.selectedReview.catererDetails[0].profilesrc === 'undefined' ? this.state.selectedLunchOrder.profilesrc : this.state.selectedReview.catererDetails[0].profilesrc}
                    catererName={typeof this.state.selectedReview.catererDetails[0].catererName === 'undefined' ? this.state.selectedLunchOrder.catererName : this.state.selectedReview.catererDetails[0].catererName}
                    starCount={typeof this.state.selectedReview.customerRating === 'undefined' ? 0 : this.state.selectedReview.customerRating}
                    reviewComment={typeof this.state.selectedReview.customerComment === 'undefined' ? "" : this.state.selectedReview.customerComment}>
                </ReviewModal> 
