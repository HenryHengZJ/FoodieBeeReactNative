        ...
        const notificationMarginTop = showNotification ? 10 : 0;
            ...
            return (
                ...
                <ReviewModal
                    ...
                    profilesrc={Object.keys(this.state.selectedReview).length === 0 ? this.state.selectedLunchOrder.profilesrc : this.state.selectedReview.catererDetails[0].profilesrc}
                    catererName={Object.keys(this.state.selectedReview).length === 0 ? this.state.selectedLunchOrder.catererName : this.state.selectedReview.catererDetails[0].catererName}
