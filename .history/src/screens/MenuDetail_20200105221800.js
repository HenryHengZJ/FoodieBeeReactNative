        ...
        return (
            ...
            <ScrollView         
                ...
                <View 
                    ...
                    <Text style={{ textDecorationLine: this.state.customerIsPrime === true ? 'line-through' : null, alignSelf: 'center', marginLeft: 20, marginRight: 10, color: 'black', fontWeight: '500', fontSize: 23}}>
