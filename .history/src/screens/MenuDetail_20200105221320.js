        ...
        return (
            ...
            <ScrollView         
                ...
                <View 
                    ...
                    <Text style={{ alignSelf: 'center', marginLeft: 10, marginRight: 10, color: 'black', fontWeight: '500', fontSize: 23}}>
                        €{Number(selectedLunchMenu.priceperunit).toFixed(2)}
                    </Text>

                    <Text style={{ alignSelf: 'center', marginLeft: 20, marginRight: 0, color: 'black', fontWeight: '500', fontSize: 23}}>
